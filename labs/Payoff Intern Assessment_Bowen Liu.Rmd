...
Based on the Debt-to-income(dti) charts, we can find the loan status of "Current" and "Fully Paid" have uanimously lower dti than Defaults and others negative status. And dti could be used as one predictors for the "Defaluts" status
