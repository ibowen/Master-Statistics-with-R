...
mature, premise, marital, lowbirthweight, gender, habit, whitemom
...
```{r}
bayes_inference(y = lowbirthweight, data = nc, success = "low", statistic = "proportion", type = "ht", null = 0.075, alternative = "twosided", beta_prior=c(0.6,0.4))
```
...
```{r}
bayes_inference(x = habit, y = lowbirthweight, data = nc, success = "low", statistic = "proportion", type = "ht", null = 0, alternative = "twosided")
```
...
```{r}
bayes_inference(x = habit, y = premie, data = nc, success = "premie", statistic = "proportion", type = "ht", null = 0, alternative = "twosided")
```
